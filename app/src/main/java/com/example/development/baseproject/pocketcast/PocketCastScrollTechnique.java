package com.example.development.baseproject.pocketcast;
...
import com.example.development.baseproject.basic.ObservableScrollView;
import com.example.development.baseproject.basic.ObservableScrollViewCallbacks;
import com.example.development.baseproject.basic.ScrollState;
import com.example.development.baseproject.basic.ScrollUtils;
import com.example.development.baseproject.basic.WindowCompatUtils;

import butterknife.Bind;
import butterknife.ButterKnife;

public class PocketCastScrollTechnique extends BaseActivity implements ObservableScrollViewCallbacks {
     ...
     //   mTitleView.setText(getTitle());
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(PocketCastScrollTechnique.this, "FAB is clicked", Toast.LENGTH_SHORT).show();
            }
        });
...
//        });
    ...
    public void onScrollChanged(int scrollY, boolean firstScroll, boolean dragging) {
        ...
        if(scrollY>=flexibleRange){
            ...
            mToolbarView.setBackgroundColor(getResources().getColor(android.R.color.transparent));
        }
